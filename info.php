                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="firstname" id="firstname" value="<?php if ($client['firstname']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="middlename" id="middlename" value="<?php if ($client['middlename']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="lastname" id="lastname" value="<?php if ($client['lastname']) {
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Age</label>
                                                                                <input type="text" name="Age" id="Age" value="<?php if ($client['age']) {
                                                                                                                                    print_r($client['age']);
                                                                                                                                }  ?>" disabled />
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="initials" id="initials" value="<?php if ($client['initials']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="id_number" id="id_number" value="<?php if ($client['id_number']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="marital_status" id="marital_status" style="width: 100%;">
                                                                                    <option value="<?= $client['marital_status'] ?>"><?php if ($client) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="education_level" id="education_level" style="width: 100%;">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="occupation" id="occupation" value="<?php if ($client['occupation']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="national_id" id="national_id" value="<?php if ($client['national_id']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="phone_number" id="phone_number" value="<?php if ($client['phone_number']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="other_phone" id="other_phone" value="<?php if ($client['other_phone']) {
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="street" id="street" value="<?php if ($client['street']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Region</label>
                                                                                <input type="text" name="region" id="region" value="<?php if ($client['region']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="district" id="district" value="<?php if ($client['district']) {
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="row-form clearfix">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Ward</label>
                                                                                <input type="text" name="ward" id="ward" value="<?php if ($client['ward']) {
                                                                                                                                    print_r($client['ward']);
                                                                                                                                }  ?>" />
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="row-form clearfix">
                                                                            <!-- select -->
                                                                            <div class="form-group">
                                                                                <label>Did the participant consent to be part of the study?</label>
                                                                        ...
                                                                        <div class="row-form clearfix"> -->
                                                                            ...
                                                                            <!-- <div class="form-group">
                                                                                ...
                                                                                <select name="pt_type" id="pt_type" style="width: 100%;" required>
                                                                                    <?php
                                                                                    if ($client['pt_type'] == 1) { ?>
                                                                                        <option value="<?= $client['pt_type'] ?>">New Patient</option>
                                                                                    <?php } else if ($client['pt_type'] == 2) { ?>
                                                                                        <option value="<?= $client['pt_type'] ?>">Already Enrolled</option>
                                                                                    <?php } else { ?>
                                                                                        <option value="">Select</option>
                                                                                    <?php
                                                                                    } ?>
                                                                            ...
                                                                            <!-- <div class="form-group">
                                                                                ...
                                                                                <select name="treatment_type" id="treatment_type" style="width: 100%;" required>
                                                                                    ...
                                                                                    if ($client['treatment_type'] == 1) { ?>
                                                                                        <option value="<?= $client['treatment_type'] ?>">Radiotherapy Treatment</option>
